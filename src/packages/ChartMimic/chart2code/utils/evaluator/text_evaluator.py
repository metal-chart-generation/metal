...
class TextEvaluator:
    ...
    def _calculate_metrics(self, generation_texts: List[Tuple], golden_texts: List[Tuple]):
        """
        ...
        # print("golden_texts", golden_texts)
        # print("generation_texts", generation_texts)

        if self.use_position == False:
